...
export type LOGIC_GAME_START = { type: typeof LOGIC_GAME_START, roomName: Name, newRoom?: boolean }
export type LOGIC_PLAYERS_READY = { type: typeof LOGIC_PLAYERS_READY, roomName: Name }
